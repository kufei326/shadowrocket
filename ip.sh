...
#完整域名
hostname=dubai.kufei.eu.org
#空间ID
zone_id=5c40f0178500f24a007796ecfecc718d
#Global API Key
api_key=ae80bbd6ef7beb4164b5ab0d1a94eb3ca7bc4
###################################################################################################
##openwrt科学上网插件配置
#优选节点时是否自动停止科学上网服务 true=自动停止 false=不停止 默认为 true
pause=false
#填写openwrt使用的是哪个科学上网客户端，填写对应的“数字”  默认为 1  客户端为passwall
# 1=passwall 2=passwall2 3=ShadowSocksR Plus+ 4=clash
clien=1
###################################################################################################
##CloudflareST配置
#测速地址  
CFST_URL=https://cachefly.cachefly.net/100mb.test
